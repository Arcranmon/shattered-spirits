        ...
        <div v-if="character.Name != ''">
          <v-row style="margin: 1em">
            ...
            <v-col :cols="columnNumbers">
              ...
              <base-widget
                :ability="character.CurrentStance"
                :on_sheet="true"
                style="margin: auto"
                :key="character.CurrentStance.Name" />
            </v-col>
          </v-row>
      ...
      <v-tab-item>
        <v-row style="margin: 1em">
          ...
          <v-col :cols="columnNumbers">
            ...
            <base-widget
              :ability="character.Spirit.CurrentStance"
              :on_sheet="true"
              style="margin: auto"
              :key="character.Spirit.CurrentStance.Name" />
          </v-col>
        </v-row>
        <h3 style="text-align: center">Abilities and Equipment</h3>
        <v-card>
          ...
          <v-tabs-items v-model="ability_tab">
            ...
            <v-tab-item class="character-tab-content">
              <show-cards
                :inputs="character.Spirit.Stances"
                :collapse="false"
                :cols="2" />
            </v-tab-item>
          </v-tabs-items>
