  ...
  <div class="card--wrapper">
    <div v-bind:class="tech.Type">
      <div class="card--underline-top card--header">
        ...
        <div
          class="card--keywords"
          v-bind:class="tech.Type">
          <span v-if="tech.Attack"> </span>
          <div>
            <b>
              <display-tooltip-text
                :string="tech.categoryHeader"
                :decorate="false" />
            </b>
          </div>
          ...
          <b>
            <span
              v-for="(keyword, index) in tech.Keywords"
              :key="index"
              class="keyword--box">
              <display-tooltip-text
                :string="keyword"
    ...
    <div class="card--content">
      ...
      <div v-if="tech.HasArea">
        <display-tooltip-text :string="tech.AreaHeader" />
      </div>
      ...
      <div
        ...
        <v-expansion-panels
          ...
          flat
          tile
          :mandatory="this.character_creation ? true : false">
          <v-expansion-panel style="background-color: inherit">
            ...
            <v-expansion-panel-content class="expand--body-chart">
              <div v-if="tech.Chart.HasDamageType">
                <display-tooltip-text :string="tech.Chart.DetailsHeader" />
              </div>
              <div v-if="tech.Chart.HasMaterial">
                <display-tooltip-text :string="tech.Chart.MaterialHeader" />
              </div>
              <div v-if="tech.Chart.HasOnMiss">
                <display-tooltip-text :string="tech.Chart.OnMissHeader" />
              </div>
