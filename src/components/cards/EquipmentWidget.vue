<template>
  <div inline>
    ...
    <div class="card--content">
      <span
        v-if="equipment.Desc.length > 0"
        style="font-style: italic"
        >{{ equipment.Desc }}<br />
      </span>
      <display-tooltip-text :string="equipment.Summary" />
      <br />
      <display-tooltip-text
        v-if="equipment.HasHands"
        :string="equipment.HandsHeader" />
      <div v-if="equipment.HasTraits">
        <display-tooltip-text :string="equipment.TraitsHeader" />
      </div>
      <div v-if="equipment.HasEffect">
        <display-tooltip-text :string="equipment.EffectHeader" />
      </div>
      <div v-if="equipment.HasSpecial">
        <display-tooltip-text :string="equipment.SpecialHeader" />
      </div>
      <div
        v-for="(ability, index) in equipment.Abilities"
        :key="index"
        class="ability-box"
