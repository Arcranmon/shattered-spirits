<template>
  <span>
    ...
    <v-layout justify-center>
      <div class="button-separator">
        <v-btn
          ...
          large
          tile
          @click="$emit('chose-discipline')"
          :disabled="!character.HasDisciplines">
    ...
    <div class="centered--formatted">
      <div v-if="!character.HasSpiritDisciplines">
        <display-tooltip-text :string="'You are missing a Spirit Discipline!'" />
      </div>
      <div v-if="!character.HasStyleDisciplines">
        <display-tooltip-text :string="'You are missing a Style Discipline!'" />
      </div>
    </div>
    <v-row>
      <v-layout
    ...
    <v-row style="margin-top: 1em; margin-bottom: 1em">
      <v-layout
        ...
        <div
          ...
          class="selected--item">
          <v-btn
            @click="removeDiscipline(disc.name)"
            class="button--style"
            depressed
            tile
            block>
          ...
          <v-row v-if="character.Spirit.HasSubtype">
            <v-col
              ...
              <v-btn-toggle
                ...
                overflow-auto>
                <div
                  v-for="discipline in spirit_disciplines"
                  style="width: 100%"
                  v-bind:key="discipline.Name">
                  <v-btn
                    @click="spiritDiscipline = discipline"
                    class="button--style"
                    depressed
                    tile
                    block>
            ...
            <v-col>
              ...
              <discipline-card
                v-if="spiritDiscipline != null"
                :discipline="spiritDiscipline"
                :key="spiritDiscipline.Name" />
            </v-col>
          </v-row>
          <v-row v-else>
            <v-col cols="auto">
              <display-tooltip-text string="To select a Spirit Discipline you must first select your spirit's type and subtype!" />
            </v-col>
          </v-row>
        </v-tab-item>
        <v-tab-item
          ...
          <v-row>
            <v-col
              ...
              <v-btn-toggle
                ...
                overflow-auto>
                <div
                  v-for="discipline in style_disciplines"
                  style="width: 100%"
                  v-bind:key="discipline.Name">
                  <v-btn
                    @click="styleDiscipline = discipline"
                    class="button--style"
                    depressed
                    tile
                    block>
            ...
            <v-col>
              ...
              <discipline-card
                v-if="styleDiscipline != null"
                :discipline="styleDiscipline"
                :key="styleDiscipline.Name" />
            </v-col>
          </v-row>
        </v-tab-item>
      </v-tabs-items>
