    ...
    <div class="button-separator">
      ...
      <v-layout justify-center>
        <v-btn
          ...
          tile
          color="success"
          @click="$emit('chose-subtype')"
          style="margin-top: 1em"
          :disabled="!character.Spirit.HasSubtype"
          :key="tracker">
    ...
    <div>
      <v-row>
        <v-col
          ...
          <div>
            <i>
              <display-tooltip-text :string="$store.getters.getGlossaryItem(subtype.Name)" />
            </i>
          </div>
          <v-btn
            ...
            <img
              ...
              :src="artSymbol(subtype.Name)" />{{ subtype.Name }}
            <img
              class="image--icon-size image--right"
              :src="artSymbol(subtype.Name)" />
          </v-btn>
        </v-col>
      </v-row>
      <div
        v-if="character.Spirit.HasSubtype"
        :key="character.Spirit.Subtype.Name">
        <div
          class="page--description table--top"
          style="width: 100%">
          <i>
          ...
          <display-tooltip-text
            style="margin-left: 1em; margin-right: 1em"
            class="page--description"
            :string="art.TagsHeader" />
          <br />
          <display-tooltip-text
            style="margin-left: 1em; margin-right: 1em"
            class="page--description"
            :string="art.Mechanics" />
          <br />
        </div>
        <div
          class="page--description"
        ...
        <v-row justify="center">
          <v-col :cols="num_cols">
            <subtype-card :type="character.Spirit.Subtype" />
          </v-col>
        </v-row>
        <div
          class="page--description"
        ...
        <div class="body">
          <v-row justify="center">
            <v-col
              :cols="num_cols"
              v-for="tech in art.Tier1Techniques"
              :key="tech.Name">
              <tech-card :tech="tech" />
            </v-col>
            <v-col
              :cols="num_cols"
              v-for="attack in art.Tier1Attacks"
              :key="attack.Name">
              <weapon-widget :attack="attack" />
            </v-col>
            <v-col
              :cols="num_cols"
              v-for="man in art.Tier1Maneuvers"
              :key="man.Name">
              <maneuver-card
                :maneuver="man"
                :format_text="true" />
        ...
        <div class="body">
          <v-row justify="center">
            <v-col
              :cols="num_cols"
              v-for="stance in art.Tier2Stances"
              :key="stance.Name">
              <stance-card :stance="stance" />
            </v-col>
            <v-col
              :cols="num_cols"
              v-for="attack in art.Tier2Attacks"
              :key="attack.Name">
              <weapon-widget :attack="attack" />
            </v-col>
            <v-col
              :cols="num_cols"
              v-for="tech in art.Tier2Techniques"
              :key="tech.Name">
              <tech-card :tech="tech" />
            </v-col>
            <v-col
              :cols="num_cols"
              v-for="man in art.Tier2Maneuvers"
              :key="man.Name">
              <maneuver-card
                :maneuver="man"
                :format_text="true" />
