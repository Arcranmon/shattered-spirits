...
Vue.prototype.$speed = require('@/assets/Move.svg')
...
import { GlossaryItem, Ability, AbilityPackage, Armor, Equipment, Weapon, Terrain, Status } from '@/class'
