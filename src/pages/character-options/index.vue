<template>
  <v-row class="page" style="margin-top: 1em">
    ...
    <v-col style="padding-left: 0">
      ...
      <show-cards v-if="tabs[selectedIndex] == 'Archetypes'" :inputs="archetypes" :collapse="false" />
      <show-cards v-if="tabs[selectedIndex] == 'Talents'" :inputs="talents" :collapse="false" />
...
export default Vue.extend({
  ...
  data() {
    return {
      ...
      tabs: ['Basic Skills', 'Archetypes', 'Talents', 'Spirit Arts', 'Spirit Customization', 'Armor and Accessories', 'Weapons and Shields', 'Consumables'],
