...
class Refresh {
  ...
  public get FormattedText() {
    ...
    if (this.focus_ != 0)
      formatted_string = this.focus_.toString() + " _Focus_";
    if (this.grit_ != 0)
      formatted_string = this.SmartCommas(
        this.grit_.toString() + " _Grit_",
        formatted_string
      );
    if (this.momentum_ != 0)
      formatted_string = this.SmartCommas(
    ...
    if (this.reflex_ != 0)
      formatted_string = this.SmartCommas(
        this.reflex_.toString() + " _Reflex_",
        formatted_string
      );
    if (this.additional_ != "")
      formatted_string = this.SmartCommas(this.additional_, formatted_string);
